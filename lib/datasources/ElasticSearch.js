...
ElasticSearch.buildUrl = function(defaults, reqData){
    var url = defaults.connection.endpointUrl +'/'+ defaults.connection.index +'/'+ defaults.connection.type;
...
ElasticSearch.addMethod('init', function(cb){
    ...
    defaults.connection.endpointUrl = defaults.connection.endpointUrl.replace(/\/$/,'');
    var indexUrl = defaults.connection.endpointUrl + '/' + defaults.connection.index;
