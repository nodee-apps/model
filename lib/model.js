...
Model.createConstructor = function(schema, superProto, parentProto){
    ...
    newCnst.extendSchema = function(obj){ return object.extend(true, schema, obj); };
    ...
    newCnst.prototype.addHiddenProperty('__instanceof', function(modelName){ return (this.constructor.__parents||[]).indexOf(modelName) > -1 || this.constructor._name===modelName; }); // have to be hidden
    newCnst.__typeof = function(modelName){ return (this.__parents||[]).indexOf(modelName) > -1 || this._name===modelName; };
